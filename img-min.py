...
qr=qrcode.QRCode(border=1,version=1,error_correction=qrcode.constants.ERROR_CORRECT_L)
qr.add_data("mse.mehvix.com")
img=qr.make_image(fit=True)
img=img.resize((23,23),Image.NEAREST)
arr=array(img).tolist()[::-1] 
moves=[]
